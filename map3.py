...
# Leer CSV desde GitHub (tu mismo dataset original)
...
# ✅ NUEVO: Checkbox de filtro solo para Pachuca
solo_pachuca = st.sidebar.checkbox("Mostrar solo Pachuca De Soto")

if solo_pachuca:
    # Solo mantenemos aquellos registros cuyas direcciones contengan "Pachuca De Soto"
